...
import sys
class Concave_cone():
    def __init__(self,beishu,r1,r2 ,h , alpha,beta ,x, y,z,work="环凹",folder="0"):
        print("这是一个环形凹区域")
            ...
            for height in range(1):
                for angle in range(beta):
                    for radius in range(r1, r2):
                        face_a = Face(self.p[height * ((r2 - r1 + 1) * beta) + (angle + 1) % beta * (
                        ...
                        face_num = 1 + face_num
                        self.c[height * (0 + beta * (r2 - r1)) + 0 + angle * (r2 - r1) + radius - r1 + 1].add_face(
                            face_a)
            ...
            for height in range(h, h + 1):
                for angle in range(beta):
                    for radius in range(r1, r2):
                        ...
                        face_num = 1 + face_num
                        self.c[
                            (height - 1) * (0 + beta * (r2 - r1)) + 0 + angle * (r2 - r1) + radius - r1 + 1].add_face(
                            face_a)
        ...
        def wall_solve():
            ...
            for height in range(h):
                for angle in range(beta):
                    face_a = Face(
                        self.p[height * (0 + (r2 - r1 + 1) * beta) + 0 + (angle + 1) % beta * (r2 - r1 + 1) + 1],
                        self.p[height * (0 + (r2 - r1 + 1) * beta) + 0 + angle * (r2 - r1 + 1) + 1],
                        self.p[(height + 1) * (0 + (r2 - r1 + 1) * beta) + 0 + angle * (r2 - r1 + 1) + 1],
                        self.p[(height + 1) * (0 + (r2 - r1 + 1) * beta) + 0 + (angle + 1) % beta * (r2 - r1 + 1) + 1],
                        face_num, 3)
                    face_num = face_num + 1
                ...
                for angle in range(beta):
                    ...
                    for radius in range(r1, r2 - 1):
                        ...
                        file.write('4 ' + hex(
                            ...
                            height * (beta * (r2 - r1)) + angle * (r2 - r1) + radius - r1 + 2)[
                        ...
                        face_a = Face(
                            ...
                            self.p[(height + 1) * (0 + (r2 - r1 + 1) * beta) + 0 + angle * (
                                ...
                                (height + 1) * (0 + (r2 - r1 + 1) * beta) + 0 + angle * (
                                        r2 - r1 + 1) + radius - r1 + 2], face_num, 2)
                        face_num = 1 + face_num
                        self.c[height * (0 + beta * (r2 - r1)) + 0 + (angle - 1) % beta * (
                                    r2 - r1) + radius - r1 + 1].add_face(
                            face_a)
                        self.c[height * (0 + beta * (r2 - r1)) + 0 + angle * (r2 - r1) + radius - r1 + 1].add_face(
                            face_a)
                        self.f[3].append(face_a)
        ...
        def p_solve():
            ...
            for height in range(h + 1):
                ...
                for angle in range(beta):
                    for radius in range(r1, r2 + 1):
                        point_a = Point(((radius-r1)/(r2-r1)*(r2-r)+r) * math.cos((angle / beta - 3 / 8) * 2 * math.pi)/beishu + x,
                                        ((radius-r1) /(r2-r1)*(r2-r)+r) * math.sin((angle / beta - 3 / 8) * 2 * math.pi)/beishu + y, height/4 + z, p_num)
